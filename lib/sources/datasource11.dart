...
class EmployeeDataSource11 extends DataGridSource {
  EmployeeDataSource11({required List<Employee> employees}) {
  ...
  void buildDataGridRows(List<Employee> employees) {
    dataGridRows = employees
      ...
      DataGridCell<String>(columnName: 'name2', value: dataGridRow.name_inclass),
      DataGridCell<String>(
          columnName: 'designation', value: dataGridRow.designation_inclass),
      DataGridCell<String>(
          columnName: 'designation2', value: dataGridRow.designation_inclass),
      DataGridCell<int>(
          columnName: 'salary', value: dataGridRow.salary_inclass),
      DataGridCell<int>(
          columnName: 'salary2', value: dataGridRow.salary_inclass),
    ]))
        .toList();
  }
