...
class EmployeeDataSource3 extends DataGridSource {
  EmployeeDataSource3({required List<Employee> employees}) {
  ...
  void updateDataGridSource() {
    notifyListeners(); //notifyListeners should be called from inside the DataGridSource.
  }
  void updateDataGridSource2({required RowColumnIndex rowColumnIndex}) {
