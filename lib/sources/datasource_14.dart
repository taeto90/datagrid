...
class EmployeeDataSource14 extends DataGridSource {
  EmployeeDataSource14({required List<Employee> employees}) {
        ...
        cells: row.getCells().map<Widget>((dataGridCell) {
          ...
          return Container(
              ...
              child: Text(
                ...
                style: dataGridCell.columnName == 'name'? TextStyle(color: Colors.pinkAccent):null,
